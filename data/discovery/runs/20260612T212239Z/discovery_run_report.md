...
- Run timestamp: 20260612T212239Z
- Seed count: 413
- Generated queries count: 448
- Search API status: disabled_missing_credentials
- External discovery enabled: false
- External candidates found: 0
- Analyzed candidates count: 413
- Valid aanbod_url count: 295
- Suspect count: 28
- Missing count: 90
- Rejected count: 18
...
External discovery was not executed because GOOGLE_CUSTOM_SEARCH_API_KEY or GOOGLE_CUSTOM_SEARCH_ENGINE_ID is missing. This run only analyzed local seed data.
...
| Alphen-Chaam | 2 | 1 | 0 | 1 | 0 | 1 | 3 |
| Altena | 20 | 10 | 4 | 5 | 1 | 11 | 27 |
| Asten | 4 | 3 | 0 | 1 | 0 | 3 | 3 |
...
| Eindhoven | 20 | 11 | 4 | 5 | 0 | 11 | 23 |
| Etten-Leur | 6 | 5 | 0 | 1 | 0 | 5 | 3 |
| Geertruidenberg | 12 | 7 | 2 | 2 | 1 | 7 | 14 |
| Geldrop-Mierlo | 4 | 4 | 0 | 0 | 0 | 4 | 0 |
| Gemert-Bakel | 4 | 3 | 1 | 0 | 0 | 3 | 2 |
...
| Son en Breugel | 3 | 0 | 1 | 2 | 0 | 1 | 8 |
| Steenbergen | 1 | 1 | 0 | 0 | 0 | 1 | 0 |
| Tilburg | 20 | 16 | 3 | 1 | 0 | 16 | 9 |
| Vught | 8 | 4 | 3 | 0 | 1 | 4 | 10 |
| Waalre | 6 | 4 | 2 | 0 | 0 | 4 | 4 |
...
- Altena: weak_score=27, valid=10, suspect=4, missing=5, rejected=1
- Eindhoven: weak_score=23, valid=11, suspect=4, missing=5, rejected=0
...
- Heusden: weak_score=16, valid=11, suspect=2, missing=4, rejected=0
- Drimmelen: weak_score=14, valid=7, suspect=2, missing=2, rejected=1
- Geertruidenberg: weak_score=14, valid=7, suspect=2, missing=2, rejected=1
...
- Vught: weak_score=10, valid=4, suspect=3, missing=0, rejected=1
...
- Alphen-Chaam: priority=48, discovered=2, total=2, valid=1
...
- Son en Breugel: priority=37, discovered=3, total=3, valid=0
...
- Investigate expected gemeenten with zero discovered sources: Valkenswaard, Veldhoven.
...
- Prioritize weak gemeenten first: Altena, Eindhoven, Land van Cuijk, Breda, 's-Hertogenbosch.
